        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <img src="{{ asset('storage/'.$transaction->details->first()->product->galleries->first()->image) }}" alt="{{ $transaction->details->first()->product->name }}" class="mt-4 rounded-lg h-20">
                    ...
                    <div class="mt-8 border-t pt-8">
                        ...
                        <form action="{{ route('transactions.update', $transaction->id) }}" method="POST">
                            ...
                            <div class="flex items-center mb-4">
                                <label for="payment_status" class="mr-2 text-lg">Status:</label>
                                <select name="payment_status" id="payment_status" class="border rounded p-2">
                ...
                <div class="text-left">
                    ...
                    <div>
                        @foreach ($transaction->details as $detail)
                            ...
                            <img src="{{ asset('storage/'.$transaction->details->first()->product->galleries->first()->image) }}" alt="{{ $detail->product->name }}" class="rounded-lg" style="width: 300px">
